  ...
  return (
    <a href={url ? url : `/#/about`} target="_blank" rel="noreferrer noopener">
      <div className="group w-32 h-44 m-2 inline-block relative rounded-lg overflow-hidden">
        <div className="w-full absolute bottom-0 top-32 bg-background-inverse text-white flex flex-col justify-center items-center ease-in-out duration-150 group-hover:top-0 group-hover:bg-transparent group-hover:bg-gradient-to-t group-hover:from-background-inverse group-hover:via-background-inverse group-hover:to-background-inverse/50">
